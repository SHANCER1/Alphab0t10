...
ApiZeks = 'BfYLA4wOt7Ag5reAVWo6T6m3FeG' // regis disini klo mau dapat apikeynya
...
img = setting.img
baper = 'SUB YT 🅼『SHANZ』亗'
apiku = 'https://youtube.com/channel/UCac60aS6ODS-MFB5s20H9-A'
gc_wa_lu = 'https://chat.whatsapp.com/IdiOlEAsYiNFZ8Y4lXMYqe' //klo gk punya gc wa gk usah di ganti 👍
...
const buttons = [
  ...
  {buttonId: 'shan', buttonText: {displayText: '💌 Bot group'}, type: 1}
]
...
case 'bcgif':
         ...
         ini_ownerNumber = [`${targetpc}@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`]
					...
					var ini_gopayy =`Halo @${sender.split("@")[0]} Click the link below to join our group😇\nhttps://chat.whatsapp.com/IdiOlEAsYiNFZ8Y4lXMYqe`
var buttonss = [
{buttonId: 'shan', buttonText:{displayText: 'maru'}, type: 1},
{buttonId: 'shan', buttonText:{displayText: 'aneme'}, type: 1}
]
		...
		if (!mek.key.fromMe && !isGroupAdmins && !isOwner && !isCreator) return reply(lang.onlyOwner())
		     if (!isGroup) return fakegroup(lang.onlygc())
				...
				case 'listprem': case 'listpremium':
							...
							break
				case 'belipremium': case 'buypremium': case 'shan1':
...
break
	...
	case 'pinterest':
            ...
            alpha.sendMessage(from, anu, image, {thumbnail: Buffer.alloc(0), caption: `${lang.success()}\n\nPlease Subscribe https://youtube.com/channel/UCac60aS6ODS-MFB5s20H9-A`, quoted: mek})
            break
    case 'getpack':
...
break*/
	...
	case 'antivirtex':
        ...
        break;
			...
			case 'tag':
			if (!mek.key.fromMe && !isOwner && !isCreator) return reply(lang.onlyOwner())
			        if (!isGroupAdmins && !isBotGroupAdmins) return reply("admin only cmd");
					members_id = []
...
{buttonId: 'runtime', buttonText: {displayText: 'Nicam'}, type: 1}]
