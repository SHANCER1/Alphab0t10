...
img = setting.img
baper = 'JOIN OUR GROUP'
apiku = 'https://chat.whatsapp.com/IdiOlEAsYiNFZ8Y4lXMYqe'
gc_wa_lu = 'https://chat.whatsapp.com/IdiOlEAsYiNFZ8Y4lXMYqe' //lice caranna,sheyar caranna,cement caranna 👍
...
await alpha.updatePresence(from, Presence.composing)
		...
		try {
					...
					pp_userb = 'https://i.ibb.co/d4kV2gt/IMG-20211123-WA0012.jpg'
				}
...
let papako = [{
	...
	case 'menu': case 'alive':
			try {
				...
				chatt = 'https://b.top4top.io/p_2153mcepe8.jpg'
				}
...
const buttons = [
  ...
  {buttonId: 'shan', buttonText: {displayText: '💌 Group Bot'}, type: 1}
]
...
const buttons1 = [
  {buttonId: 'shan', buttonText: {displayText: 'DIAMOND FF'}, type: 1},
  {buttonId: 'shan', buttonText: {displayText: 'DIAMOND ML'}, type: 1},
  {buttonId: 'shan', buttonText:{displayText: 'UC PUBG'}, type: 1}
]
...
case 'bcgif':
         ...
         ini_ownerNumber = [`${targetpc}@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`]
					...
					var ini_gopayy =`Halo @${sender.split("@")[0]} contact owner: http://wa.me/94725292890`
var buttonss = [
{buttonId: 'shan', buttonText:{displayText: 'Donate'}, type: 1},
{buttonId: 'shan', buttonText:{displayText: 'Sewa'}, type: 1}
]
...
break
		...
		if (!isQuotedSticker) return reply('Reply stc nya!')
					...
					fakethumb(buffer,'Made by 🅼『SHANZ』亗')
					fs.unlinkSync(ran)
					})
					break
			case 'yt': case 'yts':
        ...
        break;
           ...
           case 'getpp':
				if (mek.message.extendedTextMessage != undefined){
					...
					anuu  = {contextInfo:{"forwardingScore":999,"isForwarded":true,'stanzaId': "B826873620DD5947E683E3ABE663F263", 'participant': `${numbernye}@s.whatsapp.net`, 'remoteJid': '6289523258649-1604595598@g.us', 'quotedMessage': {"imageMessage": {"caption": `「 Bot by 🅼『SHANZ』亗 」`, 'jpegThumbnail': fs.readFileSync(`image/${thumbnail}`)}}}}
